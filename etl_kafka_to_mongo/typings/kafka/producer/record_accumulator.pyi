...
class ProducerBatch:
    ...
    def done(self, base_offset=..., timestamp_ms=..., exception=..., log_start_offset=..., global_error=...): # -> None:
        ...
...
class RecordAccumulator:
    ...
    def append(self, tp, timestamp_ms, key, value, headers, max_time_to_block_ms, estimated_size=...): # -> tuple[Any, Any | Literal[True], Literal[False]] | tuple[FutureRecordMetadata, bool, Literal[True]]:
