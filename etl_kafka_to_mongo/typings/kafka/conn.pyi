...
class BrokerConnection:
    ...
    def check_version(self, timeout=..., strict=..., topics=...): # -> tuple[int, int, int] | tuple[Literal[0], Literal[10], Literal[0]] | tuple[int, int]:
...
def dns_lookup(host, port, afi=...): # -> list[tuple[AddressFamily, SocketKind, int, str, tuple[str, int] | tuple[str, int, int, int]]] | list[Any]:
