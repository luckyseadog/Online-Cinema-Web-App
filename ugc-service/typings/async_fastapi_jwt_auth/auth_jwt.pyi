...
class AuthJWT(AuthConfig):
    ...
    async def create_access_token(self, subject: Union[str, int], fresh: Optional[bool] = ..., algorithm: Optional[str] = ..., headers: Optional[Dict] = ..., expires_time: Optional[Union[timedelta, int, bool]] = ..., audience: Optional[Union[str, Sequence[str]]] = ..., user_claims: Optional[Dict] = ...) -> str:
        """
    ...
    async def create_refresh_token(self, subject: Union[str, int], algorithm: Optional[str] = ..., headers: Optional[Dict] = ..., expires_time: Optional[Union[timedelta, int, bool]] = ..., audience: Optional[Union[str, Sequence[str]]] = ..., user_claims: Optional[Dict] = ...) -> str:
        """
    ...
    async def set_access_cookies(self, encoded_access_token: str, response: Optional[Response] = ..., max_age: Optional[int] = ...) -> None:
        """
    ...
    async def set_refresh_cookies(self, encoded_refresh_token: str, response: Optional[Response] = ..., max_age: Optional[int] = ...) -> None:
        """
    ...
    async def unset_jwt_cookies(self, response: Optional[Response] = ...) -> None:
        """
    ...
    async def unset_access_cookies(self, response: Optional[Response] = ...) -> None:
        """
    ...
    async def unset_refresh_cookies(self, response: Optional[Response] = ...) -> None:
        """
    ...
    async def jwt_required(self, auth_from: str = ..., token: Optional[str] = ..., websocket: Optional[WebSocket] = ..., csrf_token: Optional[str] = ...) -> None:
        """
    ...
    async def jwt_optional(self, auth_from: str = ..., token: Optional[str] = ..., websocket: Optional[WebSocket] = ..., csrf_token: Optional[str] = ...) -> None:
        """
    ...
    async def jwt_refresh_token_required(self, auth_from: str = ..., token: Optional[str] = ..., websocket: Optional[WebSocket] = ..., csrf_token: Optional[str] = ...) -> None:
        """
    ...
    async def fresh_jwt_required(self, auth_from: str = ..., token: Optional[str] = ..., websocket: Optional[WebSocket] = ..., csrf_token: Optional[str] = ...) -> None:
        """
    ...
    async def get_raw_jwt(self, encoded_token: Optional[str] = ...) -> Optional[Dict[str, Union[str, int, bool]]]:
        """
    ...
    async def get_jwt_subject(self) -> Optional[Union[str, int, UUID]]:
        """
    ...
    async def get_unverified_jwt_headers(self, encoded_token: Optional[str] = ...) -> dict:
        """
