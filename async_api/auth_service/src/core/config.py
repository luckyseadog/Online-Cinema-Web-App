...
class Settings(BaseSettings):
    ...
    redis_port: int = Field(6378, alias='REDIS_PORT')
    ...
    pg_port: int = Field(5431, alias='AUTH_DB_PORT')
    ...
    role_super_admin_description: str = Field('superadmin role description', alias='SUPERADMIN_ROLE_DESCRIPTION')
