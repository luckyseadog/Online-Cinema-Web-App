...
from opentelemetry.sdk.environment_variables import OTEL_EXPERIMENTAL_RESOURCE_DETECTORS, OTEL_RESOURCE_ATTRIBUTES, OTEL_SERVICE_NAME
...
class Resource:
    ...
    @staticmethod
    def create(attributes: typing.Optional[Attributes] = ..., schema_url: typing.Optional[str] = ...) -> Resource:
...
def get_aggregated_resources(detectors: typing.List[ResourceDetector], initial_resource: typing.Optional[Resource] = ..., timeout: int = ...) -> Resource:
