...
class SamplingResult:
    ...
    def __init__(self, decision: Decision, attributes: Attributes = ..., trace_state: Optional[TraceState] = ...) -> None:
        ...
...
class Sampler(abc.ABC):
    @abc.abstractmethod
    def should_sample(self, parent_context: Optional[Context], trace_id: int, name: str, kind: Optional[SpanKind] = ..., attributes: Attributes = ..., links: Optional[Sequence[Link]] = ..., trace_state: Optional[TraceState] = ...) -> SamplingResult:
        ...
...
class ParentBased(Sampler):
    ...
    Args:
        ...
        local_parent_not_sampled: Sampler called for a local parent that is
            not sampled.
    """
    def __init__(self, root: Sampler, remote_parent_sampled: Sampler = ..., remote_parent_not_sampled: Sampler = ..., local_parent_sampled: Sampler = ..., local_parent_not_sampled: Sampler = ...) -> None:
        ...
