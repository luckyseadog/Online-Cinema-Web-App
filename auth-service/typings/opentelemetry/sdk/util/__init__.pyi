...
from typing import Iterable, Iterator, Mapping, MutableMapping, Sequence, TypeVar, overload
from opentelemetry.util.types import AttributeValue, AttributesAsKey
...
class BoundedDict(MutableMapping[_KT, _VT]):
    ...
    @classmethod
    def from_map(cls, maxlen: int, mapping: Mapping[_KT, _VT]) -> BoundedDict[_KT, _VT]:
        ...
