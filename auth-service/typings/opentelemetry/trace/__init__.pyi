...
from opentelemetry.trace.span import DEFAULT_TRACE_OPTIONS, DEFAULT_TRACE_STATE, INVALID_SPAN, INVALID_SPAN_CONTEXT, INVALID_SPAN_ID, INVALID_TRACE_ID, NonRecordingSpan, Span, SpanContext, TraceFlags, TraceState, format_span_id, format_trace_id
...
class TracerProvider(ABC):
    @abstractmethod
    def get_tracer(self, instrumenting_module_name: str, instrumenting_library_version: typing.Optional[str] = ..., schema_url: typing.Optional[str] = ..., attributes: typing.Optional[types.Attributes] = ...) -> Tracer:
...
class Tracer(ABC):
    ...
    """
    @abstractmethod
    def start_span(self, name: str, context: Optional[Context] = ..., kind: SpanKind = ..., attributes: types.Attributes = ..., links: _Links = ..., start_time: Optional[int] = ..., record_exception: bool = ..., set_status_on_exception: bool = ...) -> Span:
        """Starts a span.
    ...
    @abstractmethod
    def start_as_current_span(self, name: str, context: Optional[Context] = ..., kind: SpanKind = ..., attributes: types.Attributes = ..., links: _Links = ..., start_time: Optional[int] = ..., record_exception: bool = ..., set_status_on_exception: bool = ..., end_on_exit: bool = ...)->Any:
...
class ProxyTracer(Tracer):
    def __init__(self, instrumenting_module_name: str, instrumenting_library_version: typing.Optional[str] = ..., schema_url: typing.Optional[str] = ..., attributes: typing.Optional[types.Attributes] = ...) -> None:
        ...
...
class NoOpTracer(Tracer):
    ...
    @_agnosticcontextmanager
    def start_as_current_span(self, name: str, context: Optional[Context] = ..., kind: SpanKind = ..., attributes: types.Attributes = ..., links: _Links = ..., start_time: Optional[int] = ..., record_exception: bool = ..., set_status_on_exception: bool = ..., end_on_exit: bool = ...) -> Iterator[Span]:
        ...
...
_TRACER_PROVIDER: Optional[TracerProvider] = ...
_PROXY_TRACER_PROVIDER = ...
def get_tracer(instrumenting_module_name: str, instrumenting_library_version: typing.Optional[str] = ..., tracer_provider: Optional[TracerProvider] = ..., schema_url: typing.Optional[str] = ..., attributes: typing.Optional[types.Attributes] = ...) -> Tracer:
    """Returns a `Tracer` for use by the given instrumentation library.
...
@_agnosticcontextmanager
def use_span(span: Span, end_on_exit: bool = ..., record_exception: bool = ..., set_status_on_exception: bool = ...) -> Iterator[Span]:
