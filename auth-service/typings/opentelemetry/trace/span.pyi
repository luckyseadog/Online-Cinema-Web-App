...
class Span(abc.ABC):
    ...
    @abc.abstractmethod
    def add_event(self, name: str, attributes: types.Attributes = ..., timestamp: typing.Optional[int] = ...) -> None:
        """Adds an `Event`.
    ...
    @abc.abstractmethod
    def record_exception(self, exception: BaseException, attributes: types.Attributes = ..., timestamp: typing.Optional[int] = ..., escaped: bool = ...) -> None:
    ...
    def __exit__(self, exc_type: typing.Optional[typing.Type[BaseException]], exc_val: typing.Optional[BaseException], exc_tb: typing.Optional[python_types.TracebackType]) -> None:
...
class TraceState(typing.Mapping[str, str]):
    ...
    """
    def __init__(self, entries: typing.Optional[typing.Sequence[typing.Tuple[str, str]]] = ...) -> None:
        ...
...
class SpanContext(typing.Tuple[int, int, bool, "TraceFlags", "TraceState", bool]):
    ...
    """
    def __new__(cls, trace_id: int, span_id: int, is_remote: bool, trace_flags: typing.Optional[TraceFlags] = ..., trace_state: typing.Optional[TraceState] = ...) -> SpanContext:
        ...
