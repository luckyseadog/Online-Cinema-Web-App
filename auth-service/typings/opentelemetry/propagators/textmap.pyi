...
default_getter: Getter[CarrierT] = ...
...
default_setter: Setter[CarrierT] = ...
class TextMapPropagator(abc.ABC):
    ...
    """
    @abc.abstractmethod
    def extract(self, carrier: CarrierT, context: typing.Optional[Context] = ..., getter: Getter[CarrierT] = ...) -> Context:
    ...
    @abc.abstractmethod
    def inject(self, carrier: CarrierT, context: typing.Optional[Context] = ..., setter: Setter[CarrierT] = ...) -> None:
