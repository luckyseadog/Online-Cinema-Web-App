...
"""
logger = ...
def extract(carrier: textmap.CarrierT, context: Optional[Context] = ..., getter: textmap.Getter[textmap.CarrierT] = ...) -> Context:
...
def inject(carrier: textmap.CarrierT, context: Optional[Context] = ..., setter: textmap.Setter[textmap.CarrierT] = ...) -> None:
