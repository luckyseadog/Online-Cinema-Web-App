...
@deprecated(version="1.25.0", reason="Use :py:const:`opentelemetry.semconv._incubating.attributes.CloudProviderValues` instead.")
...
@deprecated(version="1.25.0", reason="Use :py:const:`opentelemetry.semconv._incubating.attributes.CloudPlatformValues` instead.")
...
@deprecated(version="1.25.0", reason="Use :py:const:`opentelemetry.semconv._incubating.attributes.AwsEcsLaunchtypeValues` instead.")
class AwsEcsLaunchtypeValues(Enum):
    EC2 = ...
    FARGATE = ...


@deprecated(version="1.25.0", reason="Use :py:const:`opentelemetry.semconv._incubating.attributes.HostArchValues` instead.")
...
@deprecated(version="1.25.0", reason="Use :py:const:`opentelemetry.semconv._incubating.attributes.OsTypeValues` instead.")
...
@deprecated(version="1.25.0", reason="Use :py:const:`opentelemetry.semconv.attributes.TelemetrySdkLanguageValues` instead.")
