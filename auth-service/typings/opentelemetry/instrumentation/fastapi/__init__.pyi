...
class FastAPIInstrumentor(BaseInstrumentor):
    ...
    _original_fastapi = ...
    @staticmethod
    def instrument_app(app: fastapi.FastAPI, server_request_hook: ServerRequestHook = ..., client_request_hook: ClientRequestHook = ..., client_response_hook: ClientResponseHook = ..., tracer_provider: Any=..., meter_provider: Any=..., excluded_urls: Any=..., http_capture_headers_server_request: list[str] | None = ..., http_capture_headers_server_response: list[str] | None = ..., http_capture_headers_sanitize_fields: list[str] | None = ...)->Any:
