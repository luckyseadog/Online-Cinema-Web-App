...
from opentelemetry.metrics._internal.instrument import CallbackT, Counter, Gauge, Histogram, NoOpCounter, NoOpGauge, NoOpHistogram, NoOpObservableCounter, NoOpObservableGauge, NoOpObservableUpDownCounter, NoOpUpDownCounter, ObservableCounter, ObservableGauge, ObservableUpDownCounter, UpDownCounter, _ProxyCounter, _ProxyGauge, _ProxyHistogram, _ProxyObservableCounter, _ProxyObservableGauge, _ProxyObservableUpDownCounter, _ProxyUpDownCounter
...
"""
_logger = ...
_ProxyInstrumentT = Union[_ProxyCounter, _ProxyHistogram, _ProxyGauge, _ProxyObservableCounter, _ProxyObservableGauge, _ProxyObservableUpDownCounter, _ProxyUpDownCounter,]
...
class Meter(ABC):
    ...
    @abstractmethod
    def create_observable_counter(self, name: str, callbacks: Optional[Sequence[CallbackT]] = ..., unit: str = ..., description: str = ...) -> ObservableCounter:
    ...
    @abstractmethod
    def create_observable_gauge(self, name: str, callbacks: Optional[Sequence[CallbackT]] = ..., unit: str = ..., description: str = ...) -> ObservableGauge:
    ...
    @abstractmethod
    def create_observable_up_down_counter(self, name: str, callbacks: Optional[Sequence[CallbackT]] = ..., unit: str = ..., description: str = ...) -> ObservableUpDownCounter:
...
_METER_PROVIDER: Optional[MeterProvider] = ...
_PROXY_METER_PROVIDER = ...
def get_meter(name: str, version: str = ..., meter_provider: Optional[MeterProvider] = ..., schema_url: Optional[str] = ...) -> Meter:
    """Returns a `Meter` for use by the given instrumentation library.
