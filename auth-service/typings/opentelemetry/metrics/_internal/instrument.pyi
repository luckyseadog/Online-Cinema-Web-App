...
from typing import Callable, Generator, Generic, Iterable, Optional, Sequence, TypeVar, Union
...
CallbackT = Union[Callable[[CallbackOptions], Iterable[Observation]], Generator[Iterable[Observation], CallbackOptions, None],]
...
class _ProxyAsynchronousInstrument(_ProxyInstrument[InstrumentT]):
    def __init__(self, name: str, callbacks: Optional[Sequence[CallbackT]] = ..., unit: str = ..., description: str = ...) -> None:
        ...
...
class Counter(Synchronous):
    ...
    @abstractmethod
    def add(self, amount: Union[int, float], attributes: Optional[Attributes] = ...) -> None:
        ...
...
class Histogram(Synchronous):
    ...
    """
    @abstractmethod
    def record(self, amount: Union[int, float], attributes: Optional[Attributes] = ...) -> None:
        ...
...
class Gauge(Synchronous):
    ...
    @abstractmethod
    def set(self, amount: Union[int, float], attributes: Optional[Attributes] = ...) -> None:
        ...
