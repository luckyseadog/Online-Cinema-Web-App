...
class AuthJWT(AuthConfig):
    ...
    async def create_access_token(self, subject: Union[str, int], fresh: Optional[bool] = ..., algorithm: Optional[str] = ..., headers: Optional[dict[Any, Any]] = ..., expires_time: Optional[Union[timedelta, int, bool]] = ..., audience: Optional[Union[str, Sequence[str]]] = ..., user_claims: Optional[dict[Any, Any]] = ...) -> str:
        """
