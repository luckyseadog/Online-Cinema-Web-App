...
class RequestHeader_v1(Struct):
    SCHEMA = ...
    def __init__(
        self, request: Request, correlation_id: int = ..., client_id: str = ..., tags: dict[int, bytes] | None = ...
    ) -> None: ...
...
class Request(Struct, abc.ABC):
    ...
    def build_request_header(self, correlation_id: int, client_id: str) -> RequestHeader_v0 | RequestHeader_v1: ...
    def parse_response_header(self, read_buffer: BytesIO | bytes) -> ResponseHeader_v0 | ResponseHeader_v1: ...

class Response(Struct, abc.ABC):
    @property
    @abc.abstractmethod
    def API_KEY(self) -> int:
