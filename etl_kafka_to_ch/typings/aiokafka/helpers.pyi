...
def create_ssl_context(
    *,
    cafile: str | bytes | PathLike[str] | PathLike[bytes] | None = ...,
    capath: str | bytes | PathLike[str] | PathLike[bytes] | None = ...,
    cadata: str | Buffer | None = ...,
    certfile: str | bytes | PathLike[str] | PathLike[bytes] | None = ...,
    keyfile: str | bytes | PathLike[str] | PathLike[bytes] | None = ...,
    password: Callable[[], str | bytes | bytearray] | str | bytes | bytearray | None = ...,
) -> SSLContext:
    """
