...
class LegacyRecordBatchBuilderProtocol(Protocol):
    ...
    def size_in_bytes(self, offset: int, timestamp: int, key: bytes | None, value: bytes | None) -> int:
...
class MemoryRecordsProtocol(Protocol):
    ...
    def next_batch(self) -> DefaultRecordBatchProtocol | LegacyRecordBatchProtocol | None: ...
