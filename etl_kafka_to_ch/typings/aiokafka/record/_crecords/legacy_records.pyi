...
from aiokafka.record._types import CodecGzipT, CodecLz4T, CodecMaskT, CodecSnappyT, LegacyCompressionTypeT

@final
class LegacyRecord(LegacyRecordProtocol):
    def __init__(
        self, offset: int, timestamp: int, attributes: int, key: bytes | None, value: bytes | None, crc: int
    ) -> None: ...
    @property
    def offset(self) -> int: ...
    @property
...
class LegacyRecordBatchBuilder(LegacyRecordBatchBuilderProtocol):
    ...
    CODEC_SNAPPY: ClassVar[CodecSnappyT]
    CODEC_LZ4: ClassVar[CodecLz4T]
    def __init__(self, magic: int, compression_type: LegacyCompressionTypeT, batch_size: int) -> None: ...
    def append(
        self, offset: int, timestamp: int | None, key: bytes | None, value: bytes | None, headers: Any = ...
    ) -> LegacyRecordMetadata: ...
    def size(self) -> int: ...
    def size_in_bytes(self, offset: Any, timestamp: Any, key: Buffer | None, value: Buffer | None) -> int: ...
    @staticmethod
