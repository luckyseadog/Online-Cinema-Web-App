...
class AIOKafkaConsumer:
    ...
    async def committed(self, partition):  # -> None:
    ...
    def partitions_for_topic(self, topic):  # -> Set[int] | None:
    ...
    async def position(self, partition):  # -> int:
    ...
    def last_stable_offset(self, partition):  # -> None:
    ...
    def last_poll_timestamp(self, partition):  # -> None:
    ...
    async def seek_to_beginning(self, *partitions):  # -> bool:
    ...
    async def seek_to_end(self, *partitions):  # -> bool:
    ...
    async def seek_to_committed(self, *partitions):  # -> dict[Any, Any]:
    ...
    async def offsets_for_times(self, timestamps):  # -> dict[Any, Any]:
        """
    ...
    async def beginning_offsets(self, partitions):  # -> dict[Any, Any]:
    ...
    async def end_offsets(self, partitions):  # -> dict[Any, Any]:
    ...
    async def getmany(
        self, *partitions: Any, timeout_ms: int | None = ..., max_records: Any | None = ...
    ) -> dict[TopicPartition, list[ConsumerRecord[str, Any]]]:
        ...
